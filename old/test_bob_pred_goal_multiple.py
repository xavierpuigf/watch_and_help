...
if __name__ == '__main__':
    ...
    # pred_file = 'test_json_output_graph_sort_avg_insamelen_hid512_larger_largerv2_smallerv2_tranf_dp0_lstmavg_h2l1.p'
    pred_file = 'test_json_output_graph_multi_classifer_sort_insamelen_hid512_larger_largerv2_smallerv2_tranf_dp0_lstmavg_h4l1-new_newtest.p'
    ...
    args.record_dir = 'record_scratch/rec_good_test/multiBob_env_task_set_{}_predgoal_multiple2'.format(args.num_per_apartment)
    executable_args = {
    ...
    L = [[250]*5 for _ in range(len(episode_ids))]
    #seeds =
    test_results = {}
