...
cd interface
python main_demo.py --task prepare_food --num-per-apartment 50 --recording --mode full --port 8088 --display 2
python main_demo.py --task put_fridge --num-per-apartment 50 --recording --mode full --port 8088 --display 2
