...
print([[(n['id'], n['class_name']) for n in gt_state['nodes'] if n['id'] == e['from_id']] for e in gt_state['edges'] if 41 in e.values()])
print([e for e in gt_state['edges'] if id_goal in e.values() and e['relation_type'] == 'INSIDE'])
...
new_graph = bel.sample_from_belief()
sim_env.reset(new_graph, task_goal)
