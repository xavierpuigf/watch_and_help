...
if __name__ == '__main__':
    ...
    for record_dir in record_dirs:
        ...
        ALO = get_metrics(alice_results, test_results, episode_ids)
        ...
        for task_name in task_names:
            ...
            AL = get_metrics(alice_results, test_results, episode_ids_task)
            al_list.append(AL)
        ...
        # print("SWS")
        # print(','.join(sws_list))
    with open('results_mcts_all_v2.json', 'w+') as f:
