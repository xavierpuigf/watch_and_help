...
parser.add_argument('--port', type=int, default=8096, help='port')
...
if __name__ == '__main__':
    ...
    args.record_dir = '../record/init7_BobRG_test_set_{}'.format(args.num_per_task)
        ...
        for episode_id in episode_ids:
            ...
            try:
                ...
                if num_agents==1:
                    ...
                    ## run your agent
                    ## ------------------------------------------------------------------------------
                    steps, finished = my_agent.run(random_goal=True)
                    if not finished:
                        failed_tasks.append(episode_id)
                    else:
                        steps_list.append(steps)
