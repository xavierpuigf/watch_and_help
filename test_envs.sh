...
cd ..
cd interface
python main_demo.py --task put_dishwasher --num-per-apartment 2 --recording
cd ..
...
cd ..
cd interface
python main_demo.py --task prepare_food --num-per-apartment 2 --recording
cd ..
...
cd ..
cd interface
python main_demo.py --task put_fridge --num-per-apartment 2 --recording
cd ..
