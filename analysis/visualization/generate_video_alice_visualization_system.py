...
def write_video(log_file, out_file, comm, file_folder, file_folder_log):
    ...
    # pdb.set_trace()
    comm.add_camera(position=[-19.28, 10.94, -6.01], rotation=[36.25, 93.45, 0.])
    pdb.set_trace()
    cam_id = 77
    ...
    for it, action in enumerate(tqdm(action_1)):
        ...
        s, m = comm.render_script([action_str],
                           ...
                           image_width=1280, image_height=960, save_pose_data=True,
...
if __name__ == '__main__':
    ...
    if args.use_editor:
        out_folder = '/Users/xavierpuig/Desktop/test_videos_paper/'
        file_names = [
            '../../record_scratch/rec_good_test/multiBob_env_task_set_20_check_neurips_test_recursive/logs_agent_300_read_book_0.pik'
