...
file_name = 'Output/logs_agent_2_read_book/0'
file_names = [
    'Output/logs_agent_171_put_fridge/0',
    'Output/logs_agent_25_setup_table/0',
    'Output/logs_agent_163_prepare_food/0',
    'Output/logs_agent_107_put_dishwasher/0'
